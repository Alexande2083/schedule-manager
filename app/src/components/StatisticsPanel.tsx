...
import { format, parseISO, isToday, isThisWeek, isThisMonth, isThisYear, getDay, subDays, startOfWeek, endOfWeek, eachDayOfInterval, startOfMonth, endOfMonth } from 'date-fns';
import { zhCN } from 'date-fns/locale';
import { BarChart3, Clock, Flame, TrendingUp, Calendar, CheckCircle2, Target, Zap, Sparkles } from 'lucide-react';
            ...
            <AreaChart data={trendData}>
              <defs>
                <linearGradient id="trendGradient" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stopColor="#d4857a" stopOpacity={0.3} />
                  <stop offset="95%" stopColor="#d4857a" stopOpacity={0} />
                </linearGradient>
              </defs>
              ...
              <Area
                ...
                dot={{ r: 3, fill: '#d4857a', strokeWidth: 0 }}
                activeDot={{ r: 5, fill: '#d4857a' }}
              />
            </AreaChart>
          </ResponsiveContainer>
        </div>
              ...
              <div key={i} className="flex-1 flex flex-col items-center gap-0.5 group">
                <div
                  className={cn(
                    ...
                    isFocus ? 'bg-[#d4857a]/60' : 'bg-[#d4857a]/25'
                  )}
                  style={{ height: `${height}%` }}
                />
                {d.hour % 4 === 0 && (
